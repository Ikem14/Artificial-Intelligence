...
class DecisionFactory:
	...
	def get_decision(self, old_sight = [], verbose = True):
		...
		#- * -
		#- - -
        #[up, down, right, left, up and left, down and left, up and right, down and right] 
		for x in range (8):
		...
		"""
					...
					if self.string_moves[self.player_Coord[1]][self.player_Coord[0]][0] == '6':
						self.change_val(0,'6') #mark as dead end
					
				#prevent the agent from making the same wrong move twice
					while self.string_moves[self.player_Coord[1]][self.player_Coord[0]][self.alt] == '1' and self.string_moves[self.player_Coord[1]][self.player_Coord[0]][self.alt] == '6':
						self.alt = random.randint(1,4)
						if self.string_moves[self.player_Coord[1]][self.player_Coord[0]][0] == '6':
							self.change_val(0,'6') #mark as dead end
	...
	def choose_direction(self):
		if self.num_rounds == 1:	
			...
			if self.next != 0:
				...
				#explore the unexplored around the agent next
